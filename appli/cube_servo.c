...
//	CUBE_SERVO_queue(CUBE_SERVO_MIDDLE_POS);
	CUBE_SERVO_addMvt(CUBE_SERVO_BOTTOM_90);
	CUBE_SERVO_addMvt(CUBE_SERVO_TOP_90);
...
void CUBE_SERVO_cage_set_pos_to_reach(position){
	CUBE_SERVO_cage_new_pos = TRUE;
	CUBE_SERVO_cage_pos_to_reach = position;

}

void CUBE_SERVO_platform_set_pos_to_reach(position){
