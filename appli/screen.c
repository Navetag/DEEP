...
void SCREEN_display(screen_type_e type, cube_s * cube){
	...
	switch (type) {
		case SCREEN_MENU:
			...
			ILI9341_DrawRectangle(SCREEN_SHUFFLE_MIN_X, SCREEN_SHUFFLE_MAX_X, SCREEN_SHUFFLE_MIN_Y, SCREEN_SHUFFLE_MAX_Y, SCREEN_SHUFFLE_COLOR);
			ILI9341_DrawRectangle(SCREEN_RESOLVE_MIN_X, SCREEN_RESOLVE_MAX_X, SCREEN_RESOLVE_MIN_Y, SCREEN_RESOLVE_MAX_Y, SCREEN_RESOLVE_COLOR);
			break;
		case SCREEN_SHUFFLING_MENU:
			ILI9341_Fill(ILI9341_COLOR_WHITE);
			ILI9341_DrawRectangle(SCREEN_CLOSE_MIN_X, SCREEN_CLOSE_MAX_X, SCREEN_CLOSE_MIN_Y, SCREEN_CLOSE_MAX_Y, SCREEN_CLOSE_COLOR);
			ILI9341_DrawRectangle(SCREEN_START_MIN_X, SCREEN_START_MAX_X, SCREEN_START_MIN_Y, SCREEN_START_MAX_Y, SCREEN_START_COLOR);
			break;
